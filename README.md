...
```O método SPLICE tem como serventia de apagar dados de um array como está sendo mostrado no exemplo. Seguindo a lógica, o splice está apagando os itens um por um do array TODOS e passando atributo pos diz que ele deve apagar o atributo da tal posição, por exemplo. Se o pos fossse valer 0, então ele apagaria o atributo da posição 0 e iria para o próximo.```
